...
function NavigationButtons() {
  ...
  return (
    <nav className="flex flex-wrap gap-10 mt-24 mb-0 max-w-full text-xl font-bold leading-none whitespace-nowrap w-[490px] max-md:mt-10 max-md:mb-2.5">
      <div className="flex flex-col flex-1 text-neutral-800">
        <button className="flex gap-8 px-4 py-3 bg-white rounded-[34px] shadow-[0px_4px_4px_rgba(0,0,0,0.25)]">
          <img
            loading="lazy"
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/68b558f9a7a9dafa0695d7d1eb6b04b06f1ce31c97326e5f62d59e32b28ae185?placeholderIfAbsent=true&apiKey=2705f1c8cdd44f6a9089432dd175790a"
            alt=""
